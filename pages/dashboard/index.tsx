      ...
      <div className='max-w-6xl mx-auto'>
        <header className='mb-10'>
          ...
          <p className='text-gray-500 mt-2'>
            Este es el resumen financiero de tu taller hoy.
          </p>
        </header>
        ...
        <div className='bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm'>
          ...
          <p className='text-gray-500 mb-8 max-w-2xl'>
            Gestiona tus materias primas, ventas de cacao y reportes desde el
            menú lateral. Recuerda que todos los movimientos quedan registrados
            con tu usuario de administrador.
          </p>
          <Link
            href='/dashboard/movements'
            className='inline-block bg-gray-900 text-white px-8 py-4 rounded-2xl font-bold hover:bg-black transition-all'
          >
            Ir a Movimientos
          </Link>
        </div>
