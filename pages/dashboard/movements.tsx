    ...
    <DashboardLayout role={session?.user?.role}>
      <div className='max-w-6xl mx-auto pb-20'>
        ...
        <div className='bg-white p-8 rounded-3xl shadow-sm border border-gray-100 mb-10'>
          <h2 className='text-sm font-bold text-indigo-600 uppercase tracking-widest mb-6'>
            ...
            <tbody className='divide-y divide-gray-50'>
              {movements.map((m) => (
                ...
                >
                  ...
                  <td className='p-6'>
                    <span
                      className={`px-4 py-1.5 rounded-full text-xs font-black tracking-tight ${
                        m.type === 'INCOME'
                  ...
                  <td
                    className={`p-6 text-right font-black text-lg ${
