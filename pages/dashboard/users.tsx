          ...
          <table className='w-full text-left'>
            <thead className='bg-gray-50/50 border-b border-gray-100'>
              <tr>
                ...
                <th className='p-6 text-[10px] font-bold text-gray-400 uppercase tracking-widest text-center'>
                  Rol
                </th>
                <th className='p-6 text-[10px] font-bold text-gray-400 uppercase tracking-widest text-right'>
                  Acciones
                </th>
              </tr>
            </thead>
